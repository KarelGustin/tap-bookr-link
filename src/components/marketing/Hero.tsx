...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-8 bg-gray-900">
      <div className="w-full max-w-2xl mx-auto text-center space-y-6">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight tracking-tight">
          ...
          <span className="text-orange-500" style={{color: 'hsl(var(--orange-accent))'}}>
            Real Website
          </span>
          .
        </h1>
        
        <h2 className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-xl mx-auto font-medium">
        ...
        <div className="space-y-4 max-w-sm mx-auto pt-6">
          <input 
            ...
            className="w-full px-5 py-4 rounded-xl border-2 border-gray-700 bg-gray-800 text-white placeholder-gray-400 text-base font-medium focus:outline-none transition-colors"
            style={{borderColor: 'rgb(55 65 81)'}}
          />
          <Button 
            asChild 
            size="lg" 
            className="w-full text-base font-bold px-6 py-4 rounded-xl text-white border-0 transition-all hover:scale-105"
